...
`;
  ...
  r.style.zIndex = '100000000000';
  const imageUrl = document.createElement('img');

  imageUrl.src = 'https://mindmaid.ai/banner/avatar/logo.gif';
  ...
  (iframeContainer.style.zIndex = '10000000000'),
    ...
    a
      ...
      : ((iframeContainer.style.display = 'block'),
        setTimeout(() => {
          ...
          r.style.backgroundColor = boxChat_colorWidgetBg;
